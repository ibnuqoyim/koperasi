            ...
            <div class="panel-body">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                            	<input type="radio" name="flag" class="flag" value="Bulan" checked="checked" /> hari&nbsp;&nbsp;
                            	<input type="radio" name="flag" class="flag" value="Tahun" /> bulan
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Angsuran Perhari <span class="require">*</span> :</label>
                            <div class="col-md-3">
